...
postgres:
	docker run --name psqlsmsproject -p 5432:5432 -e POSTGRES_USER=root -e POSTGRES_PASSWORD=smsproject -d postgres:17.2-alpine

createdb:
	docker exec -it psqlsmsproject createdb --username=root --owner=root users_db
